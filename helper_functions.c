#include "shell.h"
/**
 * str_len - Calculates the lenght of a str.
 * @str: String that needs length to be found.
 * Return: Upon success returns the length of a str. otherwise 0.
 */
...
/**
 * double_free - Free double pointer var.
...
/**
 * single_free - Will free a n amount of pointers to a str.
...
/**
 * error_printing - Prints a msg error when a comand is not found.
 * @count: A counter keeping track of the number of commands run on the shell.
 * @av: The name of the prog running the shell.
