...
/**
 * env_get_key - gets the value of an environment var
 * @key: the environment var of interest
 * @data: struct of the prog's data
 * Return: a ptr to the value of the var or NULL if it doesn't exist
 */
...
/**
 * env_set_key - overwrite the value of the environment var
 * or create it if does not exist.
 * @key: name of the variable to set
 * @value: new value
 * @data: struct of the prog's data
 * Return: 1 if the params are NULL, 2 if there is an erroror 0 if sucess.
 */
...
int env_set_key(char *key, char *value, data_of_program *data)
{
	...
	/* make a str of the form key=value */
